...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('Moka/edit');?>">新 增</a>
        <button class="btn ajax-post confirm" url="<?php echo U('Moka/del');?>" target-form="ids">删 除</button>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a title="编辑" href="<?php echo U('Moka/edit',array('id'=>$vo['id']));?>">编辑</a>
                            ...
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('Moka/del',array('id'=>$vo['id']));?>">删除</a>
                        </td>
