...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('editStyle');?>">新 增</a>
        <button class="btn ajax-post confirm" url="<?php echo U('delStyle');?>" target-form="ids">删 除</button>

        <!-- 高级搜索 -->
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="name" class="search-input" value="<?php echo I('name');?>" placeholder="请输入模卡风格">
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["id_a"]); ?></td>
                        <td><?php echo ($vo["name"]); ?></td>
                        <td><?php echo ($vo["pic_num"]); ?></td>
                        <td><?php echo (time_format($vo["create_time"])); ?></td>
                        <td>
                            <a title="编辑" href="<?php echo U('editStyle',array('id'=>$vo['id']));?>">编辑</a>
                            <a href="<?php echo U('changeField',array('id'=>$vo['id'],'value'=>abs($vo['status']-1),'model'=>'Style'));?>" class="ajax-get"><?php if(($vo["status"]) == "1"): ?>禁用<?php else: ?>启用<?php endif; ?></a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('delStyle',array('id'=>$vo['id']));?>">删除</a>
                        </td>
