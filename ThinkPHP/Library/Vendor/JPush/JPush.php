...
class JPush {
    ...
    public function __construct($appKey, $masterSecret, $logFile = self::DEFAULT_LOG_FILE, $retryTimes = self::DEFAULT_MAX_RETRY_TIMES) {
        ...
        $this->setNotBackContent(FALSE);
        $this->setConnectTimeout(self::CONNECT_TIMEOUT);
        $this->setReadTimeout(self::READ_TIMEOUT);
        $this->logFile = $logFile;
    }

    public function setReadTimeout($readTime) {
    ...
    public function setNotBackContent($back_content) {
        $this->notBackContent = $back_content;
         return $this;
    }
