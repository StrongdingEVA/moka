...
class FileModel extends Model {
    ...
    function __construct($name = '', $tablePrefix = '', $connection = '') {
        ...
        $this->driver = C('DOWNLOAD_UPLOAD_DRIVER');
        $this->config = C('UPLOAD_' . strtoupper($driver) . '_CONFIG');
        empty($this->driver) && $this->driver = 'Local';
        empty($this->config) && $this->config = null;
    }
     ...
     */
    public function upload($files, $setting = null, $driver = null, $config = null) {
        /* 上传文件 */
